...
import com.maintenenceapp.model.Trip;
import com.maintenenceapp.repo.IMaintenenceRepo;
...
public class MainteneceServiceImpl implements IMaintenenceService {
	...
	private static final String BASEURL="http://localhost:8083/task-service";
	...
	public List<Task> getTasksByMaintenenceId(int maintenenceId) {
		String url = BASEURL + "/tasks/maintenenceId/" + maintenenceId; 
